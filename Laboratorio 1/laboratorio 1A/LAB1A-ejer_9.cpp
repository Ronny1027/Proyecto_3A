...
void main()
{
	int ArregloDeCienEnteros[100];
	int i = 0;//Se declara la variable i que empieza en 0.
	while (i < 100) {//Incio del ciclo while con la condicion de que i sea menor a 100.
		ArregloDeCienEnteros[i] = i; //Se asigna el valor de i.
		cout << "Fue agregado el numero " << ArregloDeCienEnteros[i] << " en el Arreglo." << endl;/*Se muestra
		el resultado y continua el ciclo.*/
...
y luego seguir con el ciclo.En este caso se hace usando While en vez de for*/
